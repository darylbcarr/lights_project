/**
 * @file tz_lookup.cpp
 * @brief IANA → POSIX TZ lookup table
 *
 * Sources: IANA tz database + tzdata POSIX strings.
 * Covers all populated timezones used by ip-api.com responses.
 */
...
static const TzEntry TZ_TABLE[] = {
    ...
    { "Asia/Hebron",                 "EET-2EEST,M3.5.6/0:01,M9.1.5" },
    ...
    { "Asia/Qatar",                  "AST-3" },
    { "Asia/Qostanay",               "AQTT-6" },
    { "Asia/Qyzylorda",              "QYZT-5" },
    ...
    // ── Australia ─────────────────────────────────────────────────────────────
    { "Australia/Adelaide",          "CST-9:30CDT,M10.1.0,M4.1.0/3" },
    { "Australia/Brisbane",          "EST-10" },
    { "Australia/Broken_Hill",       "CST-9:30CDT,M10.1.0,M4.1.0/3" },
    { "Australia/Currie",            "EST-10EDT,M10.1.0,M4.1.0/3" },
    { "Australia/Darwin",            "CST-9:30" },
    { "Australia/Eucla",             "CWST-8:45" },
    { "Australia/Hobart",            "EST-10EDT,M10.1.0,M4.1.0/3" },
    { "Australia/Lindeman",          "EST-10" },
    { "Australia/Lord_Howe",         "LHST-10:30LHDT-11,M10.1.0,M4.1.0" },
    { "Australia/Melbourne",         "EST-10EDT,M10.1.0,M4.1.0/3" },
    { "Australia/Perth",             "WST-8" },
    { "Australia/Sydney",            "EST-10EDT,M10.1.0,M4.1.0/3" },

    // ── Europe ────────────────────────────────────────────────────────────────
    { "Europe/Amsterdam",            "CET-1CEST,M3.5.0,M10.5.0/3" },
    { "Europe/Andorra",              "CET-1CEST,M3.5.0,M10.5.0/3" },
    { "Europe/Astrakhan",            "MSK-4" },
    ...
    { "Pacific/Easter",              "EAST6EASST,M10.2.6/22,M3.2.6/22" },
    { "Pacific/Efate",               "VUT-11" },
    { "Pacific/Enderbury",           "PHOT-13" },
    { "Pacific/Fakaofo",             "TKT-13" },
    { "Pacific/Fiji",                "FJT-12FJST,M10.3.0/2,M1.3.4/3" },
    ...
    { "Pacific/Niue",                "NUT11" },
    { "Pacific/Norfolk",             "NFT-11NFDT,M10.1.0,M4.1.0/3" },
...
static constexpr int TZ_TABLE_SIZE =
    (int)(sizeof(TZ_TABLE) / sizeof(TZ_TABLE[0]));

const char* tz_lookup(const char* iana_name)
{
    if (!iana_name || iana_name[0] == '\0') return nullptr;
    for (int i = 0; i < TZ_TABLE_SIZE; ++i) {
        if (strcmp(TZ_TABLE[i].iana, iana_name) == 0) {
